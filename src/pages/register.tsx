...
const Register = () => {
  ...
  return (
    <div className="register_container theme_bg">
      <img className="bg_Img" src={bg} alt="" />
      <TopBar title="完善信息" />
      <div className="title_box">
        <div className="title">C=8</div>
        <div className="desc">只差最後一步</div>
        <div className="note theme_desc">完善信息後即可獲得金幣獎勵</div>
      </div>
      <div className="main">
        ...
        <div className="detail_box">
          ...
          <div className="top_box">
            ...
            <div className="input_box">
              <select>
                <option value="option1">男男</option>
                <option value="option2">男女</option>
